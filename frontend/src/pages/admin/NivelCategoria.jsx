...
const NivelCategoria = () => {
  ...
  const handleAddNivelCategoria = async () => {
    ...
    if (isNivel && (!gradoSeleccionado || isNaN(gradoSeleccionado))) {
    ...
    const nuevoItem = {
      nombre,
      esNivel: isNivel,
      grados: isNivel ? [gradoSeleccionado] : [], // Enviar un array de IDs
    };
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  console.log("Grado seleccionado (convertido):", valorSeleccionado); // Verifica el valor convertido
