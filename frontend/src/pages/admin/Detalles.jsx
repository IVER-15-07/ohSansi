  ...
  return (
    <div className="flex flex-col p-4 w-full">
          ...
          {areasConfig.map((area) => (
            <div
              ...
              className={`p-2 cursor-pointer rounded ${
                selectedArea.nombre === area.nombre ? "bg-blue-200" : "bg-gray-100"
              }`}
      ...
      <div className="flex justify-between mt-4">
        <button className="bg-gray-300 px-4 py-2 rounded">Atrás</button>
        <button className="bg-blue-500 text-white px-4 py-2 rounded">Finalizar</button>
      </div>
    </div>
  );
};
