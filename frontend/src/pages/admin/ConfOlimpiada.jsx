...
const ConfOlimpiada = () => {
  ...
  const {
    ...
    isLoading: isLoadingAreasDisponibles,
    error: errorAreasDisponibles,
  } = useQuery({
    queryKey: ["areas"],
    queryFn: getAreas,
  })
  ...
  const {
    data: nivelesDisponibles,
    isLoading: isLoadingNivelesDisponibles,
    error: errorNivelesDisponibles,
  } = useQuery({
