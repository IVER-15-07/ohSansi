    ...
    <div className="p-6 flex flex-col gap-4 w-full h-full min-h-[600px] max-h-[780px] bg-[#F9FAFB]">
      <div className="flex flex-col gap-4 h-full">
        <h2 className="text-xl font-bold text-gray-800">
          Configuración de Áreas y Niveles/Categorias: {nombreOlimpiada}
        </h2>
          ...
          <div className="flex gap-3">
            {step === 1 && (
              <button
                ...
                className={`px-5 py-2 rounded-md font-medium transition-colors duration-200 ${areasSeleccionadas.length === 0
            ...
            {step === 2 && (
              <button
                ...
                disabled={isAdding}
                className={`px-5 py-2 rounded-md text-white font-medium transition-colors duration-200 ${isAdding
